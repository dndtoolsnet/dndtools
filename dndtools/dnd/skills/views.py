...
def skill_list(request):
    ...
    return render(request, 'dnd/skills/skill_list.html', context={'skill_list': paginator.items(),
...
def skill_detail(request, skill_slug, rulebook_slug=None,
    ...
    return render(request, 'dnd/skills/skill_detail.html', context={'skill': skill,
