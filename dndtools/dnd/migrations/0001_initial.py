# Generated by Django 1.9.2 on 2016-02-21 20:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='item',
            name='required_feats',
            field=models.ManyToManyField(blank=True, to='dnd.Feat'),
        ),
        migrations.AddField(
            model_name='item',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='Only Armor and Magic Enhancements.', null=True, on_delete=django.db.models.deletion.CASCADE, to='dnd.Item'),
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name='spelldomainlevel',
            unique_together=set([('domain', 'spell')]),
        ),
        migrations.AlterUniqueTogether(
            name='spellclasslevel',
            unique_together=set([('character_class', 'spell')]),
        ),
        migrations.AlterUniqueTogether(
            name='spell',
            unique_together=set([('name', 'rulebook')]),
        ),
        migrations.AlterUniqueTogether(
            name='skillvariant',
            unique_together=set([('skill', 'rulebook')]),
        ),
        migrations.AlterUniqueTogether(
            name='race',
            unique_together=set([('name', 'rulebook')]),
        ...
        migrations.AlterUniqueTogether(
            name='characterclassvariant',
            unique_together=set([('character_class', 'rulebook')]),
        ),
    ]
